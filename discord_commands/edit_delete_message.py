...
def edit_message(token, channel_id, message_id, new_content):
    ...
    r = requests.patch(f"{API_BASE}/channels/{channel_id}/messages/{message_id}", headers=headers, json=payload)
...
def delete_message(token, channel_id, message_id):
    ...
    r = requests.delete(f"{API_BASE}/channels/{channel_id}/messages/{message_id}", headers=headers)
